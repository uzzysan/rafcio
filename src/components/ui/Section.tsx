...
export function SectionHeader({ title, subtitle, centered = true, className = '' }: SectionHeaderProps) {
  return (
    ...
    >
      <span className="inline-block px-4 py-1.5 mb-4 text-sm font-medium tracking-wider uppercase rounded-full bg-[var(--accent)]/10 text-[var(--accent)] border border-[var(--accent)]/20">
        {title}
      </span>
      {subtitle && (
