...
export function Projects() {
    ...
    return (
        <section id="projects" className="py-20 bg-gray-50 dark:bg-[#292524]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {projects.map((project, index) => (
                        <motion.div
                            ...
                            className="group relative bg-white dark:bg-[#1c1917] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 p-8 border border-gray-100 dark:border-white/5 flex flex-col items-center text-center"
                        >
